...
scaffold_file = open("D:\\d\\python\\rn-scaffold\\screenGeneratorJsfiles\\screenScaffold.txt","r");
...
reducer_file_scaffold = open("D:\\d\\python\\rn-scaffold\\reducerGeneratorJsfiles\\reducerSample.txt","r");
